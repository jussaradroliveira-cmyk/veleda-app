...
**MINUTA COMPLETA para revisão jurídica** · Preparada em 13/08/2026 pela equipa
técnica · Base: LGPD art. 5.º XVII e art. 38 (Brasil) e, por boa prática, RGPD
art. 35 (a operadora está em Portugal). A secção 8 (parecer) fica para a
advogada.
...
| Encarregado/DPO | **Não designado** (ver risco R8 e recomendação na secção 7) |
...
| Data / versão do relatório | 13/08/2026 · v0.1 (minuta) |
...
dados fiscais 10 anos (Stripe); backups com sobrescrita rotativa (Supabase
Pro — ativação pendente); na Anthropic, eliminação automática em prazo curto
(política comercial; sem uso para treino).
...
| Base legal (LGPD) | Execução de contrato (art. 7 V) para o serviço; consentimento (art. 7 I / art. 11 I para sensíveis inseridos pelo titular); obrigação legal (fiscal); legítimo interesse (segurança/logs) — **enquadramento a validar pela advogada** |
...
| R8 | Ausência de Encarregado/DPO designado | — | M | canal de privacidade existe (contact@) | **A definir** — LGPD art. 41 (ANPD dispensa agentes de pequeno porte de DPO, mas exige canal); advogada decide designação |
...
3. Advogada decidir sobre **designação de Encarregado** (R8) — pode ser a
   própria titular, com menção na Política.
